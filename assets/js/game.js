...
var fight = function(enemy) {  
  while (playerInfo.health > 0 && enemy.health > 0) {
    ...
    // generate random damage based on player's attack value
...
var playerInfo = {
  ...
  refillHealth: function() {
    if (this.money >=7) {
      window.alert ("Refilling players health and taking cash money");
      this.health +=20;
      this.money -=7;
    }
    else {
      window.alert ("You ain't got cash bruh");
    }
  ...
  upgradeAttack: function () {
    if (this.money >=7) {
      ...
      {
        window.alert ("Bruh, nice try, but you ain't got enough dollars");
      }
  }
};
